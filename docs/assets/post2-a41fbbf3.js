...
本研究开发了AdvMOB，一个基于城市数字孪生技术的高级交互式可视化分析系统，用于评估和分析城市环境中的广告牌曝光情况。研究的贡献包括开发了一个新模型，结合建筑结构和人类视觉范围，精确衡量广告牌的有效性；引入优化模型，整合人类流动性数据、广告牌尺寸和位置重要性，优化广告牌布局；并通过直观界面进行可视化展示，支持实时分析和决策。AdvMOB系统解决了传统方法难以应对的城市环境复杂性和动态人流，提升了广告策略的精准度和智能化水平。`;export{n as default};
